        ...
        <div className="sticky top-0 h-screen w-full overflow-hidden bg-inherit">
          ...
          {hint ? (
            ...
            >
              ...
              <span className="relative text-[0.65rem] font-medium uppercase tracking-[0.22em] opacity-70 after:absolute after:left-1/2 after:top-full after:mt-2 after:h-8 after:w-px after:bg-gradient-to-b after:from-current after:to-transparent after:content-['']">
                {hint}
              </span>
            </div>
          ) : null}
